        ...
        <div class="app-card" style="border-radius: 0 0 20px 20px; margin-top: -30px; padding-top: 40px; border-top: none; background: white; margin-bottom: 25px;">
            <div class="app-header-row" style="border-bottom:none; margin-bottom:0;">
                <div>
                    ...
                    <h2 class="app-title">Linha do Tempo</h2>
                    <p class="app-subtitle">Acompanhamento do Processo</p>
                </div>
                <!-- Animated Compass Icon -->
                <div style="background: var(--color-primary-light); color: var(--color-primary-dark); width: 45px; height: 45px; border-radius: 12px; display: flex; align-items: center; justify-content: center; font-size: 1.5rem; animation: compassWiggle 4s ease-in-out infinite;">
                    🧭
                </div>
            </div>
        </div>
